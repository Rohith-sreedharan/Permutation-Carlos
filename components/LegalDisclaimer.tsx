      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <div className="text-light-gray text-xs leading-relaxed">
            This platform provides decision engine outputs. Edges represent pricing discrepancies between our intelligence model and the sportsbook line - not guaranteed outcomes. Use these insights as part of your decision framework.
          </div>
        </div>
      </div>
    </div>
